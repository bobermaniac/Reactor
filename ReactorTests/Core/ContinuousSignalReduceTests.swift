//
//  ContinuousSignalReduceTests.swift
//  ReactorTests
//
...
class ContinuousSignalReduceTests: XCTestCase {
    ...
    override func setUp() {
        ...
        reducer = Reducer()
        collector = emitter.monitor.reduce(reducer.provideImpl())
    ...
    public func testUsesInitialValueAsInitialAccumulator() {
